...
<template><view class="semantic-region" data-region-id="payment-action" aria-label="Payment action">
    <view class="content-node content-decoration content-payment-button-background" data-content-id="payment-button-background" aria-hidden="true" />
...
.content-payment-submit-control{left:0rpx;top:0rpx;width:673.0769230769231rpx;height:103.84615384615385rpx}
.content-payment-button-label{left:232.6923076923077rpx;top:32.69230769230769rpx;width:207.6923076923077rpx;height:48.07692307692308rpx;color:var(--ui-color-text-brown);font-size:34.61538461538461rpx;font-weight:600;line-height:48.07692307692308rpx}</style>
